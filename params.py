...
parser.add_argument('--eps', type=float, default=1e-6, help='epsilon (default: 1e-6)')     # TODO: why add eps to loss?
# TODO: explain the difference between proc and exec
...
parser.add_argument('--result_folder', type=str, default='./results/', help='the folder path where test results store (default: ./results)')
parser.add_argument('--model_folder', type=str, default='./models/', help='the folder path where trained models store (default: ./models)')
...
parser.add_argument('--num_stream_jobs', type=int, default=100, help='number of all jobs generated in future (default: 100)')
# TODO: where the following two used?
parser.add_argument('--num_stream_jobs_grow', type=float, default=0.2, help='growth rate of number of streaming jobs  (default: 0.2)')
parser.add_argument('--num_stream_jobs_max', type=float, default=500, help='maximum number of streaming jobs (default: 500)')
...
# TODO: where the following two used?
parser.add_argument('--new_job_interval', type=int, default=10000, help='new job arrival interval (default: 10000 milliseconds)')
parser.add_argument('--new_job_interval_noise', type=int, default=1000, help='new DAG arrival interval noise (default: 1000 milliseconds)')

# -- Multi resource environment (not added for now) --
...
parser.add_argument('--early_terminate', type=int, default=0, help='terminate the episode when stream is empty (default: 0)')
...
parser.add_argument('--log_file_name', type=str, default='log', help='log file name (default: log)')

# TODO: GPU reset
parser.add_argument('--master_num_gpu', type=int, default=0, help='number of GPU cores used in master (default: 0)')
...
parser.add_argument('--num_worker_agents', type=int, default=16, help='number of parallel agents (default: 16)')
...
parser.add_argument('--reset_prob', type=float, default=0, help='probability for episode to reset (after x seconds) (default: 0)')
parser.add_argument('--reset_prob_decay', type=float, default=0, help='decay rate of reset probability (default: 0)')
...
# TODO: conflict with model folder?
