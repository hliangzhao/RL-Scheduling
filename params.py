...
parser.add_argument('--master_gpu_fraction', type=float, default=0.02, help='fraction of memory master uses in GPU (default: 0.5)')
parser.add_argument('--worker_gpu_fraction', type=float, default=0.01, help='fraction of memory worker uses in GPU (default: 0.1)')
parser.add_argument('--num_worker_agents', type=int, default=16, help='number of parallel agents (default: 10)')
...
parser.add_argument('--num_epochs', type=int, default=1000000, help='number of training epochs (default: 10000000)')
