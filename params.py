...
parser.add_argument('--num_exp', type=int, default=1, help='number of experiments (default: 10)')
...
# multi_res_results, multi_res_models
...
parser.add_argument('--master_gpu_fraction', type=float, default=0.4, help='fraction of memory master uses in GPU (default: 0.5)')
parser.add_argument('--worker_gpu_fraction', type=float, default=0.4, help='fraction of memory worker uses in GPU (default: 0.1)')
parser.add_argument('--num_worker_agents', type=int, default=1, help='number of parallel agents (default: 10)')
...
parser.add_argument('--num_epochs', type=int, default=10000, help='number of training epochs (default: 10000000)')
...
parser.add_argument('--model_save_interval', type=int, default=1000, help='interval for saving PyTorch model (default: 100000)')
parser.add_argument('--num_saved_models', type=int, default=10, help='number of models to keep (default: 1000)')
